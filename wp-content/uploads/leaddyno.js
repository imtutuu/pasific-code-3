var LeadDyno = LeadDyno || (function() {
    ...
    //if(window.location.pathname.split('/').filter(word => word == 'au' || word == 'nz' || word == 'sg').length > 0)
        //{
        //document.getElementById('custom_html-10').getElementsByTagName('div')[0].getElementsByTagName('div')[0].children[1].style.display =  'none';
        //}
        //else
        //document.getElementById('custom_html-10').getElementsByTagName('div')[0].getElementsByTagName('div')[0].children[1].style.display =  'inline-block';
